<div class="mb-4 h-1/2 bg-[#FEE5E0] p-4 rounded-md">
    <div class="flex justify-between">
        <h2 class="text-lg font-bold text-gray-600">Priority</h2>
        <button onclick="Livewire.emit('setCreateTaskDialog', true, 'priority')" class="p-2 bg-blue-500 text-white rounded-md text-sm">Add New Priority</button>
    </div>
